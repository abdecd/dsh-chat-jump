window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function TurnNavToggleIcon({ disabled }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
						...
						strokeWidth: "1.5",
						strokeLinecap: "round",
						opacity: disabled ? .35 : .9
					}),
					disabled && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
		...
		function ChatHistoryQuickJump({ messages = [], retryableTurns = [], disableNativeTurnNav: disableNativeTurnNavProp }) {
			...
			const [disableNativeTurnNav, setDisableNativeTurnNav] = (0, react.useState)(() => {
				if (disableNativeTurnNavProp !== void 0) return disableNativeTurnNavProp;
				try {
			...
			const toggleNativeTurnNav = (0, react.useCallback)(() => {
				setDisableNativeTurnNav((prev) => {
					const next = !prev;
					try {
						if (typeof localStorage !== "undefined") localStorage.setItem("dsh-chat-jump:disable-native-nav", String(next));
					} catch {}
					return next;
				});
			}, []);
			(0, react.useEffect)(() => {
				...
				if (!disableNativeTurnNav) {
					...
					const disabledEls = document.querySelectorAll("[data-dsh-turn-nav-disabled=\"true\"]");
				...
				const navElements = document.querySelectorAll("nav[aria-label=\"轮次导航\"], nav[aria-label=\"Turn navigation\"]");
				for (const nav of navElements) {
					if (nav.closest("[role=\"dialog\"], dialog, .dim-page, .dim-layout")) continue;
					nav.dataset.dshTurnNavDisabled = "true";
					if (nav.parentElement && nav.parentElement !== document.body && !nav.parentElement.closest("[role=\"dialog\"], dialog, .dim-page, .dim-layout")) nav.parentElement.dataset.dshTurnNavDisabled = "true";
				}
				const chatFlow = document.querySelector("[data-chat-flow]");
				if (chatFlow && chatFlow.previousElementSibling) {
					const prev = chatFlow.previousElementSibling;
					if (prev.querySelector("nav") || prev.tagName.toLowerCase() === "nav") prev.dataset.dshTurnNavDisabled = "true";
				}
				return () => {
					delete document.documentElement.dataset.dshNativeTurnNav;
					const disabledEls = document.querySelectorAll("[data-dsh-turn-nav-disabled=\"true\"]");
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: `${ChatHistoryQuickJump_module_css_default["navButton"]} ${disableNativeTurnNav ? ChatHistoryQuickJump_module_css_default["activeNavButton"] ?? "" : ""}`,
									...
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TurnNavToggleIcon, { disabled: disableNativeTurnNav })
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
